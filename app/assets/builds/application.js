(() => {
  ...
  __export(turbo_exports, {
    Turbo: () => turbo_es2017_esm_exports,
    cable: () => cable_exports
  });
...
%o`, message, error2, detail);
  ...
  var hello_controller_default;
  var init_hello_controller = __esm({
    "app/javascript/controllers/hello_controller.js"() {
      init_stimulus();
      hello_controller_default = class extends Controller {
        greet() {
...
`;
      ...
      __publicField(hello_controller_default, "targets", ["name", "result"]);
    }
  });
  ...
  console.log("DEBUG: Imported modules:", {
    turbo: typeof Promise.resolve().then(() => (init_turbo(), turbo_exports)),
    controllers: typeof Promise.resolve().then(() => (init_controllers(), controllers_exports)),
    popper: lib_exports,
    bootstrap: typeof Promise.resolve().then(() => (init_bootstrap_esm(), bootstrap_esm_exports))
  });
})();
